...
const Contact = () => {
  ...
  return (
    <div className={`lg:mt-12 flex lg:flex-row flex-col-reverse gap-4 lg:gap-5 overflow-hidden`}>
      {modalMessage && (
      ...
      <motion.div
        ...
        className="lg:flex-[0.65] flex-[0.75] bg-black-100 p-8 rounded-2xl w-full"
      >
      ...
      {!isMobile && (
        <motion.div
          ...
          className="lg:flex-[0.35] lg:h-auto md:h-[650px] h-[450px] lg:min-h-[620px]"
        >
          <EarthCanvas />
        </motion.div>
      )}
